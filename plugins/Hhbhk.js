...
cmd({
    ...
    try {
const data0 = await fetchJson(`https://vajira-official-api.vercel.app/movie/sinhalasub/search?text=${q}`);   
const data1 = data0.result.data[0].link
console.log(data1)
const data = await fetchJson(`https://vajira-official-api.vercel.app/movie/sinhalasub/movie?url=${data1}`);   	    
